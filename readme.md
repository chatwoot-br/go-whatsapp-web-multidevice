...
| `WHATSAPP_WEBHOOK_INCLUDE_OUTGOING`     | **Deprecated** (v8.5+): no-op. Outgoing webhooks are always forwarded; consumers filter on `is_from_me`. | `false` | _(deprecated, do not set)_ |
